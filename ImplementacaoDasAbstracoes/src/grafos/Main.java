...
public class Main {
    public static void main(String[] args) {
        ...
        TestGetArestaListaAdjacencia testGetArestaListaAdjacencia = new TestGetArestaListaAdjacencia();
        TestGetArestaMatrizAdjacencia testGetArestaMatrizAdjacencia = new TestGetArestaMatrizAdjacencia();
        ...
        testGetArestaListaAdjacencia.testSequencial();
        
        testGetArestaMatrizAdjacencia.testSequencial();
    }
}
